...
<head>
    ...
    <link rel="preload" as="image" href="{{ asset('override/logo/mobile-logo.png') }}">

    @if ($favicon = core()->getConfigData('general.design.admin_logo.favicon'))
        <link type="image/x-icon" href="{{ Storage::url($favicon) }}" rel="shortcut icon" sizes="16x16">
    @else
        <link type="image/x-icon" href="{{ asset('override/logo/favicon.ico') }}" rel="shortcut icon" sizes="16x16" />
    @endif
...
<body class="h-full font-inter dark:bg-gray-950">
    ...
    <div id="app" class="h-full">
        ...
        <div class="flex gap-4 group/container sidebar-collapsed" ref="appLayout">
            ...
            <div
                ...
                <div class="pt-6 mt-auto">
                    <div
                        class="py-5 text-sm font-normal text-center bg-white border-t dark:border-gray-800 dark:bg-gray-900 dark:text-white max-md:py-3">
